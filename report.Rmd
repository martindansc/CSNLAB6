...
plotEvolutions <- function(version){
  ...
  # todo, pass corerctly the parameters to the functions m0[v] and n0[v]
  m <- m0[version]
  n <- m0[version]
  ...
  stat_function(fun=function(x) theoreticalCurves[[version]], geom="line", mapping = aes(color = "Theoretical")) +
